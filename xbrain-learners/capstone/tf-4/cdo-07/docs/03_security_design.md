...
| `tf4-cdo07-eventbridge-invoke-role` | EventBridge (chu kỳ 1 phút / 1-min schedule) | `lambda:InvokeFunction` (scoped ARN: `arn:aws:lambda:ap-southeast-1:<ACCOUNT>:function:tf4-cdo07-window-feeder`) | `iam:*`, `s3:*`, `timestream:*`, `kms:*` |
